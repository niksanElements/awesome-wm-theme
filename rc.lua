...
-- TODO: see if we have good alternative
...
local global_keys = awful.util.table.join(
	...
	end, { description = "lauch apps", group = "Application" }),
	...
	end, { description = "focus the bellow window", group = "client" }),
	awful.key({ "Mod4" }, "k", function()
		awful.client.focus.bydirection("up")
	end, { description = "focus the above window", group = "client" }),
	awful.key({ "Mod4" }, "h", function()
		awful.client.focus.bydirection("left")
	end, { description = "focus the left window", group = "client" }),
	awful.key({ "Mod4" }, "l", function()
		awful.client.focus.bydirection("right")
	end, { description = "focus the right window", group = "client" }),
	...
	end, { description = "Execute default terminal (x-terminal-emulator)", group = "Application" }),

	awful.key({ "Mod4" }, "b", function()
		awful.spawn(browser)
	end, { description = "Execute default web browser (" .. browser .. ")", group = "Application" }),

	awful.key({ "Mod4", "Shift" }, "w", function()
		awful.spawn("libreoffice")
	end, { description = "Execute LibreOffice", group = "Application" }),

	awful.key({ "Mod4", "Shift" }, "e", function()
		awful.spawn("nvim-qt")
	end, { description = "Execute default graphic text editor (nvim-qt)", group = "Application" }),

	awful.key({ "Mod4", "Shift" }, "m", function()
		awful.spawn("spotify")
	end, { description = "Execute default music player (spotify)", group = "Application" }),
	awful.key({ "Mod4", "Control", "Shift" }, "Cyrillic_softsign", function()
		awful.spawn("spotify")
	end),

	awful.key({ "Mod4", "Shift" }, "f", function()
		awful.spawn(file_manager)
	end, { description = "Execute default file manager (" .. file_manager .. ")", group = "Application" }),
	...
	awful.key({ "Mod4", "Shift" }, "d", function()
		awful.spawn("discord")
	end, { description = "Execute Discord", group = "Application" }),
	-- TODO: screenshot app

	awful.key({ "Mod4", "Control", "Shift" }, "`", function()
		awful.spawn(system_monitor_command)
	end, { description = "Execute System Monitor (" .. system_monitor_command .. ")", group = "Application" }),

	awful.key({ "Mod4", "Shift" }, "k", function()
		awful.spawn("gitkraken")
	end, { description = "Execute GitKraken", group = "Application" }),
